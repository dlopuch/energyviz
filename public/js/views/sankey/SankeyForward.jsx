  ...
  <div>
    <div className="row">
      <div className="col-md-8">
        <h3>Experiment 1: Interactive Energy Flow Sankey<a name="experiment1" href="#experiment1">&nbsp;</a></h3>
        <p className="lead">
          A sankey diagram implementation that supports model-based data generation to see effects of swapping different data scenarios against a constant structure.
        </p>
      </div>
    </div>
    <div className="row">
    ...
    <div className="row">
      <div className="col-md-8">
        ...
        <p>
          <strong>Prior Art.</strong> Sankey diagrams can be interactive in that <a href="http://bl.ocks.org/Neilos/584b9a5d44d5fe00f779">nodes can be rearranged</a>, but this is useful only as an exploratory tool for a static dataset.  They can be <a href="http://infocaptor.com/sankey-diagram-software.php">dynamically generated</a> with different data sets, but these generators focus on exploring a single selected data set, not how the layout changes across data sets (eg when loading a different dataset, the transitions are sudden and the layout can change with different datasets’ scaling, making it difficult to follow the effects of applying a different model).
        </p>
        <p>
          <strong>A Model-based Sankey.</strong> This experiment presents a Sankey diagram that maintains a consistent structure but whose data values can scale by swapping out various models.  We can load data for five scenarios: <a href="https://flowcharts.llnl.gov/content/assets/images/charts/Energy/Energy_2014_United-States.png">LLNL’s 2014 US energy flow</a>, <a href="https://flowcharts.llnl.gov/content/assets/images/charts/Energy/Energy_2015_United-States.png">LLNL’s 2015 US energy flow</a>, and three energy interpolations based on the <a href="http://www.worldenergy.org/publications/2016/world-energy-scenarios-2016-the-grand-transition/">2016 WEC World Energy Scenarios report</a>. By making it easy to change the <em>data</em> rather than the <em>structure</em> of the Sankey diagram, the effects of the various scenario models can quickly be summarized and compared.
        </p>
        <p>
          ...
          <strong>&nbsp;Thus, we can summarize both energy <em>and</em> emissions flow in the same diagram.</strong> The data for emissions is also model-based so it too can be changed as the underlying model gets swapped.
        </p>
      </div>
    </div>
  </div>
